...
namespace pgsql
{
    ...
    class param_t:public field_t
    {
        ...
        {
            m_metainfo->buffer_type = pgsql_TYPE_LONG;
        ...
        {
            m_metainfo->buffer_type = pgsql_TYPE_DOUBLE;
        ...
        {
            m_metainfo->buffer_type = pgsql_TYPE_LONGLONG;
        ...
        {
            m_metainfo->buffer_type = pgsql_TYPE_DATETIME;
            m_metainfo->length_value = sizeof(value);
            value.to(*((pgsql_TIME*)m_metainfo->buffer));
            return *this;
        }
        //-------------------------------------------------
        //绑定文本串
        ...
        {
            m_metainfo->buffer_type = pgsql_TYPE_STRING;
