...
namespace rx_dbc_ora
{
    ...
    class field_t:public col_base_t
    {
        ...
        ub2 bind_data_type(query_t *rs, const char *name, ub4 name_len, ub2 oci_data_type, ub4 max_data_size, int fetch_size)
        {
            ...
            type_t::data_type_t dbc_data_type = type_t::DT_UNKNOWN;
            m_query = rs;
            ...
            default:
                throw (error_info_t(type_t::DBEC_UNSUP_TYPE, __FILE__, __LINE__, name));
            }

            //生成最终的数据缓冲区
            col_base_t::make(name, name_len, dbc_data_type, max_data_size, fetch_size, dbc_data_type == type_t::DT_TEXT);
